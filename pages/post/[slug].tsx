  ...
  return (
    <main className="">
      ...
      <article className="max-w-3xl mx-auto p-5">
        ...
        <hr className="max-w-lg my-5 mx-auto border border-y-yellow-500" />
...
//Here we get the paths to the posts
...
export const getStaticPaths = async () => {
  ...
  *[_type=="post"]{
  ...
  const posts = await sanityClient.fetch(qyery);
...
// Here we get the static props from the server
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  *[_type=="post" && slug.current == $slug][0]{
  ...
  return {
    ...
    revalidate: 60, //after 60 sec it will update the old cache version
  };
};
